<div class="dl_pricing_plan_switcher">
    <div class="dl_switcher_control">
        ...
        ?>
        <span class="dl_toggler_label dl-before-title"><?php esc_html_e($before_title, 'droit-elementor-addons-pro');?></span>
        <div class="dl_toggle">
            <div class="dl_switch"></div>
        </div>
        <span class="dl_toggler_label  dl-after-title"><?php esc_html_e($after_title, 'droit-elementor-addons-pro');?></span>
    </div>
