...
abstract class Advanced_Accordion_Control extends Widget_Base
{

    //use Controls\Style_Default;
    ...
    public function _dl_pro_accordions_content__controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Accordion', 'droit-elementor-addons-pro'),
    ...
    protected function _dl_pro_accordions_content_repeater__controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                'label' => __('Accordion Title', 'droit-elementor-addons-pro'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Accordion Title', 'droit-elementor-addons-pro'),
                'placeholder' => __('Enter your title', 'droit-elementor-addons-pro'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label' => __('After Icon', 'droit-elementor-addons-pro'),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'return_value' => 'yes',
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => __('Accordions', 'droit-elementor-addons-pro'),
                'type' => \Elementor\Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        '_dl_pro_accordions_title_' => esc_html__('Accordion Title 1', 'droit-elementor-addons-pro'),
                        '_dl_pro_accordions_description_' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'droit-elementor-addons-pro'),
                       
                    ],
                    [
                        '_dl_pro_accordions_title_' => esc_html__('Accordion Title 2', 'droit-elementor-addons-pro'),
                        '_dl_pro_accordions_description_' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'droit-elementor-addons-pro'),
                        
                    ],
                    [
                        '_dl_pro_accordions_title_' => esc_html__('Accordion Title 3', 'droit-elementor-addons-pro'),
                        '_dl_pro_accordions_description_' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'droit-elementor-addons-pro'),
                        
                    ],
                    [
                        '_dl_pro_accordions_title_' => esc_html__('Accordion Title 4', 'droit-elementor-addons-pro'),
                        '_dl_pro_accordions_description_' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'droit-elementor-addons-pro'),
    ...
    public function _dl_pro_accordions_active_style__controls(){
         ...
         $this->start_controls_section(
             ...
             [
                 'label' => esc_html__('Genaral', 'droit-elementor-addons-pro'),
    ...
    public function _dl_pro_accordion_icon_after_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Icon After', 'droit-elementor-addons-pro'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Margin Right', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
    ...
    public function _dl_pro_accordion_title_icon_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Icon', 'droit-elementor-addons-pro'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        $this->start_controls_tabs(
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Active Icon', 'droit-elementor-addons-pro' ),
				'type' => \Elementor\Controls_Manager::ICONS,
				'default' => [
    ...
    public function _dl_pro_accordions_general_style__controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Box Space', 'droit-elementor-addons-pro'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'selectors' => [
