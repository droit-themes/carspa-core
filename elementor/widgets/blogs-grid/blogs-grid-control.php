...
abstract class Blogs_Grid_Control extends Widget_Base
{
    ...
    public function _dl_pro_blog_grid_layouts_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'default_layout' => [
                        'title' => __('Default', 'droit-elementor-addons-pro'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Content Type', 'droit-elementor-addons-pro'),
                'label_block' => false,
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => ['excerpt'],
                'options' => [
                    'excerpt' => __('Excerpt', 'droit-elementor-addons-pro'),
                    'content' => __('Content', 'droit-elementor-addons-pro'),
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Posts Per Row', 'droit-elementor-addons-pro'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'min' => 1,
                'max' => 12,
                'step' => 1,
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Rows Spacing', 'droit-elementor-addons-pro'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Columns Spacing', 'droit-elementor-addons-pro'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'default' => [
                    'size' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Author Media Type', 'droit-elementor-addons-pro'),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'icon' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Date Media Type', 'droit-elementor-addons-pro'),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'icon' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Time Media Type', 'droit-elementor-addons-pro'),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'icon' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Comments Media Type', 'droit-elementor-addons-pro'),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'icon' => [
    ...
    public function _dl_pro_blog_grid_query_controls()
    {
        ...
        $this->add_control(
            ...
            array(
                ...
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'post' => __('Recent Post', 'droit-elementor-addons-pro'),
                    'category' => __('Category Post', 'droit-elementor-addons-pro'),
        ...
        $this->add_control('_dl_pro_blog_grid_category',
            [
                'label' => esc_html__('Select Categories', 'droit-elementor-addons-pro'),
                'type' => \Elementor\Controls_Manager::SELECT2,
                'multiple' => true,
                'label_block' => true,
                'default' => '1',
    ...
    public function _dl_pro_blog_grid_pagination_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => __('Enable Ajax', 'droit-elementor-addons-pro'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
    ...
    public function _dl_pro_blog_grid_show_hide_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => __('Show Category', 'droit-elementor-addons-pro'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes',
                'label_off' => __('Hide', 'droit-elementor-addons-pro'),
                'label_on' => __('Show', 'droit-elementor-addons-pro'),
    ...
    protected function _dl_pro_blog_title_hover_controls()
    {
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .dl__blog--grid-wrapper .dl__blog--grid-inner:hover .droit-blog-grid-entry-title.dl_title' => 'color: {{VALUE}}',
                ],
            ]
        );
        do_action('dl_widgets/pro/blog/grid/section/style/title/hover', $this);
    ...
    public function _dl_pro_blog_grid_content_style_controls()
    {
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => __( 'Typography', 'droit-elementor-addons-pro' ),
				'selector' => '{{WRAPPER}} .droit__post--content.dl_description',
			]
		);
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .droit__post--content.dl_description' => 'color: {{VALUE}}',
				],
			]
		);
        $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .droit__post--content.dl_description' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
        $this->end_controls_section();
    ...
    protected function _dl_blogs_grid_button_normal_controls()
    {
        ...
        $this->add_group_control(
            \Elementor\Content_Typography::get_type(),
            [
    ...
    public function _dl_blogs_grid_category_style_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Category', 'droit-elementor-addons-pro'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
    ...
    public function _dl_blogs_grid_auth_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Author', 'droit-elementor-addons-pro'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
                    $this->get_control_id('_dl_pro_blog_grid_meta_data') => 'author',
                ],
    ...
    public function _dl_blogs_grid_date_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Date', 'droit-elementor-addons-pro'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
                    $this->get_control_id('_dl_pro_blog_grid_meta_data') => 'date',
                ],
    ...
    public function _dl_blogs_grid_time_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Time', 'droit-elementor-addons-pro'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
                    $this->get_control_id('_dl_pro_blog_grid_meta_data') => 'time',
                ],
    ...
    public function _dl_blogs_grid_comments_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Comments', 'droit-elementor-addons-pro'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
                    $this->get_control_id('_dl_pro_blog_grid_meta_data') => 'comments',
                ],
