...
class Droit_Addons_Pricing_Pro extends Widget_Base{
    ...
    {
        return ' eicon-product-price addons-icon';
    }
    ...
    protected function _register_controls()
    {
        ...
        // add content 
        $this->_pricing_content_control();
        
        //style section
        $this->_pricing_styles_control();
    ...
    public function _pricing_content_control(){
        $this->_dl_pro_pricing_header();
        $this->_dl_pro_pricing_thumbnail();
        $this->_dl_pro_pricing_currency_control();
        $this->_dl_pro_pricing_feature();
        $this->_dl_pro_pricing_description();
        $this->_dl_pro_pricing_btn();
        $this->_dl_pro_pricing_badge();
        $this->_dl_pro_pricing_ordering_controls();
        //start subscribe layout end
    }
    //pricing header
    public function _dl_pro_pricing_header(){
        $this->start_controls_section(
            '_dl_pro_pricing_content_section',
            [
                'label' => esc_html__('Header', 'droit-elementor-addons-pro'),
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Sub Title', 'droit-elementor-addons-pro' ),
				'type' => \Elementor\Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __( 'One of a kind platform. One of a kind price', 'droit-elementor-addons-pro' ),
                'dynamic' => [
                    'active' => true
                ]
			]
        ...
        $this->add_control(
			...
			[
                ...
                'label_block' => true,
                'default' => __( 'Unbelieveable Price', 'droit-elementor-addons-pro'),
                'dynamic' => [
                    'active' => true
                ]
			]
    ...
    //pricing thumbnail
    public function _dl_pro_pricing_thumbnail(){
        $this->start_controls_section(
    ...
    //pricing currency
    public function _dl_pro_pricing_currency_control(){
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'dollar',
                'condition' =>[
                    $this->get_control_id('_droit_pricing_pro_enable_currency_price') => ['yes'],
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    $this->get_control_id('_droit_pricing_pro_enable_currency_price') => ['yes'],
                    $this->get_control_id('_droit_pricing_pro_currency_symbol') => ['custom'],
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    $this->get_control_id('_droit_pricing_pro_enable_currency_price') => ['yes'],
                    $this->get_control_id('_droit_pricing_pro_sale') => ['yes'],
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'dl_beside',
                'condition' => [
                    $this->get_control_id('_droit_pricing_pro_period!') => '',
                    $this->get_control_id('_droit_pricing_pro_enable_currency_price') => ['yes'],
                ]
            ]
        );
    ...
    //pricing feature
    public function _dl_pro_pricing_feature(){
        $this->start_controls_section(
            '_dl_pro_pricing_Features_section',
            [
                'label' => esc_html__('Features', 'droit-elementor-addons-pro'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => __( 'List Item', 'droit-elementor-addons-pro' ),
				'default' => __( 'List Item', 'droit-elementor-addons-pro' ),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'text' => __( 'Tincidunt ut laoreet dolor', 'droit-elementor-addons-pro' ),
						'selected_icon' => [
							'value' => 'fas fa-check',
							'library' => 'fa-solid',
						],
					...
					[
						'text' => __( 'Sed diam nonummy', 'droit-elementor-addons-pro' ),
						'selected_icon' => [
							'value' => 'fas fa-check',
							'library' => 'fa-solid',
						],
    ...
    //pricing description
    public function _dl_pro_pricing_description(){
        $this->start_controls_section(
            '_dl_pro_pricing_description_section',
            [
                'label' => esc_html__('Description', 'droit-elementor-addons-pro'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_control(
			...
			[
				...
				'default' => __( 'Default description', 'droit-elementor-addons-pro' ),
				'placeholder' => __( 'Type your description here', 'droit-elementor-addons-pro' ),
			]
		);
        $this->end_controls_section();
    }
    //peicing btn
    public function _dl_pro_pricing_btn(){
        $this->start_controls_section(
    ...
    //peicing badge
    public function _dl_pro_pricing_badge(){
        $this->start_controls_section(
            '_dl_pro_pricing_badge_section',
            [
                'label' => esc_html__('Badge', 'droit-elementor-addons-pro'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_control(
			...
			[
				'label' => __( 'Show Badge', 'droit-elementor-addons-pro' ),
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Badge Text', 'droit-elementor-addons-pro' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Popular', 'droit-elementor-addons-pro' ),
                'dynamic' => [
                    'active' => true
                ],
                'condition' =>[
    ...
    //Ordering Repeater
    public function _dl_pro_pricing_ordering_controls(){
        $this->start_controls_section(
    ...
    //style tab section
    public function _pricing_styles_control(){
        $this ->_dl_pro_pricing_general_style();
        $this ->_dl_pro_pricing_header_style();
        $this ->_dl_pro_pricing_thumb_style();
        $this ->_dl_pro_pricing_price_style();
        $this ->_dl_pro_pricing_feature_style();
        $this ->_dl_pro_pricing_btn_style();
        $this ->_dl_pro_pricing_note_style();
        $this ->_dl_pro_pricing_badge_style();
    }

    //pricing general
    public function _dl_pro_pricing_general_style()
    {
        $this->start_controls_section(
    ...
    //pricing header
    public function _dl_pro_pricing_header_style()
    {
        $this->start_controls_section(
    ...
    //pricing thumbnail
    public function _dl_pro_pricing_thumb_style()
    {
        $this->start_controls_section(
    ...
    //feature
    public function _dl_pro_pricing_price_style()
    {
        $this->start_controls_section(
			'_dl_pro_pricing_price_section',
			[
				'label' => __( 'Price', 'droit-elementor-addons-pro' ),
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Original Price', 'droit-elementor-addons-pro' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Symbol', 'droit-elementor-addons-pro' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Price Priod', 'droit-elementor-addons-pro' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
    ...
    //feature
    public function _dl_pro_pricing_feature_style()
    {
        $this->start_controls_section(
			'section_icon_list',
			[
				'label' => __( 'Featute list', 'droit-elementor-addons-pro' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
        ...
        $this->add_responsive_control(
			'pricing_list_space',
			[
				'label' => __( 'Item Space', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'divider_style',
			[
				'label' => __( 'Style', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'solid' => __( 'Solid', 'droit-elementor-addons-pro' ),
					'double' => __( 'Double', 'droit-elementor-addons-pro' ),
					'dotted' => __( 'Dotted', 'droit-elementor-addons-pro' ),
					'dashed' => __( 'Dashed', 'droit-elementor-addons-pro' ),
				],
				'default' => 'solid',
				'condition' => [
					'divider' => 'yes',
		...
		$this->add_control(
			'divider_weight',
			[
				'label' => __( 'Weight', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 1,
				],
        ...
        $this->add_control(
			'more_options1',
			[
				'label' => __( 'Feature Icon', 'droit-elementor-addons-pro' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
        ...
        $this->add_control(
			'more_options',
			[
				'label' => __( 'Feature Text', 'droit-elementor-addons-pro' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'text_color',
			[
				'label' => __( 'Text Color', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'text_indent',
			[
				'label' => __( 'Text Indent', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
    ...
    // button
    public function _dl_pro_pricing_btn_style()
    {
        $this->start_controls_section(
    ...
    //pricing note
    public function _dl_pro_pricing_note_style()
    {
        $this->start_controls_section(
            '_dl_pricing_pro_note_section',
            [
                'label' => esc_html__('Note', 'droit-elementor-addons-pro'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
    ...
    //pricing note
    public function _dl_pro_pricing_badge_style()
    {
        $this->start_controls_section(
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Transform', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'min' => -200,
    ...
    {   
        ...
        if ( ! empty( $this->get_pricing_settings('_droit_pricing_pro_currency_symbol') ) ) {
            if ( '_droit_pricing_pro_custom' !== $this->get_pricing_settings('_droit_pricing_pro_currency_symbol') ) {
                $symbol = $this->droit_get_currency_symbol( $this->get_pricing_settings('_droit_pricing_pro_currency_symbol') );
            } else {
                $symbol = $this->get_pricing_settings('_droit_pricing_pro_currency_symbol_custom');
            }
        }
        $currency_format = empty( $this->get_pricing_settings('_droit_pricing_pro_currency_format') ) ? '.' : $this->get_pricing_settings('_droit_pricing_pro_currency_format');
        $price = explode( $currency_format, $this->get_pricing_settings('_droit_pricing_pro_price_text') );
        $intpart = $price[0];
        $fraction = '';
        if ( 2 === count( $price ) ) {
            $fraction = $price[1];
        ...
        $period_position = $this->get_pricing_settings('_droit_pricing_pro_period_position');
        $period_element = '<span class="droit_price_duration droit-price-period " ' . $this->get_render_attribute_string( '_droit_pricing_pro_period' ) . '>' . $this->get_pricing_settings('_droit_pricing_pro_period') . '</span>';
                    ...
                    <?php if ($_droit_pricing_pro_enable_currency_price == 'yes'): ?>
                        ...
                        <ul <?php echo $this->get_render_attribute_string( 'icon_list' ); ?>>
                            ...
                            <li <?php echo $this->get_render_attribute_string( 'list_item' ); ?>>
                                ...
                                <?php endif; ?>
                                <span class="droit_pricing_feature_list"><?php echo $item['text']; ?></span>
                            </li>
                        <?php endforeach;?>
                        </ul>
                    <?php
