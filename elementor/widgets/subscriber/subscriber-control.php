...
abstract class Subscriber_Control extends Widget_Base
{
    ...
    protected function _dl_pro_subscriber_content_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Genaral', 'droit-elementor-addons-pro' ),
    ...
    protected function _dl_pro_subscriber_checkbox_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Checkbox Style', 'droit-elementor-addons-pro' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function _dl_pro_subscriber_btn_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Button Style', 'droit-elementor-addons-pro' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function _dl_pro_subscriber_input_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Input Style', 'droit-elementor-addons-pro' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    public function _dl_pro_subs_from_wrapper_style()
    {
		...
		$this->add_control(
            ...
            [
                'label' => __( 'Content Alignment', 'droit-elementor-addons-pro' ),
                'type' => Controls_Manager::SELECT,
                // 'label_block' => false,
    ...
    public function _dl_pro_subs_from_btn_style()
    {
        ...
        $this->add_group_control(
            ...
            [
                'name' => '_dl_pro_subs_from_btn_normal_controls',
                'label' => __( 'Button Typography', 'droit-elementor-addons-pro' ),
                'selector' => '{{WRAPPER}} .dl_pro_subscribe_form .dl_cu_btn ',
            ]
        );
    ...
    public function _dl_pro_subs_from_input_style()
    {
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Paceholder Color', 'droit-elementor-addons-pro' ),
				'type' => \Elementor\Controls_Manager::COLOR,
        ...
        $this->add_responsive_control(
			...
			[
                'label' => __( 'input Col Width', 'droit-elementor-addons-pro' ),
                'type' => \Elementor\Controls_Manager::NUMBER,
				'min' => 5,
				'max' => 100,
				'step' => 1,
		...
		$this->add_responsive_control(
			...
			[
                'label' => __( 'input Col Margin', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
        ...
        $this->start_controls_tab('_dl_pro_search_form_hover',
            [
                'label' => esc_html__('Focus', 'droit-elementor-addons-pro'),
            ]
        );
    ...
    public function _dl_pro_subs_from_checkbox_style()
    {
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Checkbox Width', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
