...
abstract class Video_Popup_Control extends Widget_Base
{
    // Get Control ID
    ...
    public function _dl_pro_video_popup_content_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Button Content', 'droit-elementor-addons-pro'),
    ...
    public function _dl_pro_popup_video_content_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Video', 'droit-elementor-addons-pro'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
    ...
    protected function _dl_pro_popup_video_controls()
    {
        $this->add_control(
            ...
            [
                ...
                'default' => 'youtube',
                'options' => [
                    'youtube' => __('YouTube', 'droit-elementor-addons-pro'),
                    'vimeo' => __('Vimeo', 'droit-elementor-addons-pro'),
                ],
            ]
        );
        ...
        $this->add_control(
            'embed_url',
            [
                'label' => __('Video URL', 'droit-elementor-addons-pro'),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __('https://www.youtube.com/watch?v=XHOmBV4js_E', 'droit-elementor-addons-pro'),
        ...
        $this->add_control(
            'controls',
            [
                'label' => __('Player Controls', 'droit-elementor-addons-pro'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'droit-elementor-addons-pro'),
                'label_off' => esc_html__('No', 'droit-elementor-addons-pro'),
                'return_value' => 1,
